    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-1 z-10 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-0 md:mt-0">
          {/* Internal navigation to TicketPricing */}
          <Link
            to="/TicketPricing"
            className="relative cursor-pointer sujoy text-sm sm:text-base px-6 py-3 bg-yellow-400 font-bold text-black border-4 border-yellow-800 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-transform inline-block"
          >
            Register now
          </Link>
          ...
          {/* External navigation */}
          <a
            href="https://gdg.community.dev/gdg-durgapur/"
            target="_blank"
            rel="noopener noreferrer"
            className="relative cursor-pointer sujoy text-sm sm:text-base px-6 py-3 bg-emerald-800 font-bold text-black border-4 border-emerald-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-transform inline-block"
          >
            Join us
          </a>
        </div>
