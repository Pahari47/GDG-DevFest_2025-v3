...
export default function TeamSection() {
  ...
  return (
    <section className="w-full xl:max-w-7xl mx-auto pt-28 xl:pt-34 pb-12 px-6">
      ...
      {organizer.map((team, i) => (
        <div key={i} className="mb-16">
          ...
          <div className="flex justify-center">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-12 h-auto w-auto">
      ...
      {teams.map((team, i) => (
        <div key={i} className="mb-16">
          ...
          <div className="flex justify-center">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-12 h-auto w-auto">
              {team.members.map((member, idx) => (
                <div key={idx} className="flex flex-col items-center text-center">
                  <div className="relative aspect-square w-[200px] overflow-hidden rounded">
                    <div
